...
$sql="select 
    site.sitecode, areaValidated, province.provinceName, commonname, quantity
from
    site
        inner join
    ...
    validation ON site.sitecode = validation.sitecode
        inner join
    seedling ON seedling.validationID = validation.validationID
        inner join
    species ON species.speciesID = seedling.speciesID ".$q."order by 1, 3, 4";
